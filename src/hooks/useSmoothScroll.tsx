...
export const useSmoothScroll = (path: string) => {
  ...
  useEffect(() => {
    ...
    const scrolled = (e: Event | WheelEvent) => {
      e.preventDefault(); // disable default scrolling

      const delta = normalizeWheelDelta(e as WheelEvent);

      pos.current += -delta * speed.current;
    ...
    const update = () => {
      moving = true;
      const delta =
        (pos.current - (target as HTMLElement).scrollTop) / smooth.current;
