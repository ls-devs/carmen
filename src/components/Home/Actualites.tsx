...
export const Actualite: React.FC<ActualiteProps> = ({addToItems, screenWidth, position}) => {
    ...
    >
      ...
      <div className="flex w-full flex-col p-4 sm:p-6">
        ...
        <p className="font-thunderLC text-sm text-cream-carmen sm:text-lg">
          ...
          Carmen, le "restaurant des abattoirs", c'est plonger dans une ambiance bistrot conviviale
          où les bons produits faits maison
        </p>
      </div>
    </div>
  );
