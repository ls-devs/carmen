...
export const Footer =  /* optimize */ block(() => {
  ...
  return (
    ...
    >
          ...
          <div className="mt-5 flex w-full items-center justify-center min-[425px]:m-0 min-[425px]:justify-end">
            ...
            >
              <path
                ...
                fill={`${route === "/actualites" || route === "/la-carte" ? "#fff7e7" : " #780000"}`}
              ></path>
            </svg>
            <svg
              className="m-2 h-[45px] w-[45px] min-[425px]:m-1 min-[425px]:h-[35px] min-[425px]:w-[35px]"
            ...
            >
              ...
              <path
                ...
                fill={`${route === "/actualites" || route === "/la-carte" ? "#780000" : "#fff7e7"}`}
                stroke="#780000"
                strokeWidth="0.1"
              ></path>
            </svg>
      ...
      <Image
        src={`/img/footer/footer_bg_${route === "/actualites" || route === "/la-carte" ? "red" : "white"}.png`}
        alt="Carmen Footer"
        width={1100}
        height={300}
