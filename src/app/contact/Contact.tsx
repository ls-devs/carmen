...
export const Contact = () => {
  ...
  const sendEmail = async (
    ...
    try {
      await fetch(
        `${process.env.NEXT_PUBLIC_CARMEN_ADMIN_AJAX}?action=mail_before_submit&toemail=${toEmail}&message=Email de : ${data.NOM} ${data.PRENOM}<br>Email de contact : ${data.EMAIL}<br>Téléphone: ${data.TEL}<br>Objet : ${data.OBJECT}<br>Contenu du message : ${data.MESSAGE}<br>`
      );
    } catch (error) {
          ...
          <div className="flex items-start justify-start space-x-3 p-4 lg:mb-[100px]">
            <div className="flex w-[150px] min-w-[150px] flex-col">
              <Image
                ...
                height={220}
              />
              <p className="font-thunder text-xl text-red-carmen">
                #ChezCarmenToulouse #InstaFood #SudOuest #RestoToulouse
              </p>
            </div>
            <div className="flex w-[150px] min-w-[150px] flex-col">
              <Image
